    ...
    if content:
        ...
        try:
            with open('output2.json', 'r') as f:
                ...
                test_input = str(processed_content)
                print(test_input)
                syntax_review_task = Task(
                    description=test_input,
                    expected_output="""
                    Generate a 300-word story based on the provided content.
                    
                    Name, Business, Location
                    Who she is/what she does.Use professional & informative tone for this paragraph. It must provide factual information about client’s background, her career transition, and the business she founded. The tone is serious and respectful, reflecting the gravity and importance of the work being discussed. It must convey admiration for client's expertise and dedication to her field. The style of this paragraph is concise and straightforward using specific details to convey the subject's expertise and the business's unique value.
                    How she got there.The voice of this para is professional and authoritative. It provides detailed information about the client’s company. The tone is informative and matter-of-fact. The style of this paragraph is clear and precise, with a focus on providing specific details about client’s company and their applications.
                    Then, If provided by the user insert a short/impactful quote from her in invertted commas.
                    Problem or opportunity In <year> she joined the WeBC <name of program>.What the program did for her 
                    """,
                    agent=general_agent,
                    human_input=False
                )
